...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-[hsl(133,8%,75%)] to-[hsl(151,73%,56%)] px-1 pb-1 text-[hsl(153,100%,11%)] dark:from-secondary dark:to-primary`,
        className,
      )}
    >
      {children}
